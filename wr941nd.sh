...
#Hostaname
sed -i 's/OpenWrt/tp-link/g' package/base-files/files/bin/config_generate
#NTP Server Brazil
...
#Version
sed -i 's/OPENWRT_RELEASE="%D %V %C"/OPENWRT_RELEASE="Sirherobrine23 Firmare 19.07 $(date)/g' package/base-files/files/usr/lib/os-release
