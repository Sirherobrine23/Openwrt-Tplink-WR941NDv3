...
# meus pacotes (BETA)
# Internet Status
cp ../internet-status.sh package/base-files/files/bin/status
chmod +x package/base-files/files/bin/status
chmod 775 package/base-files/files/bin/status

# Auto Update
cp ../system-autoupdate.sh package/base-files/files/bin/system-autoupdate
chmod +x package/base-files/files/bin/system-autoupdate
chmod 775 package/base-files/files/bin/system-autoupdate
# init status
